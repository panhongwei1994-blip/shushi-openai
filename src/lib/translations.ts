...
export const translations: Record<Locale, Dictionary> = {
	en: {
		...
		story: {
			title: 'Built to feel like a refined sushi counter, made to order fast on any screen.',
			body: 'From nigiri and sashimi to signature rolls and combo boxes, the experience keeps the menu elegant, the product details clear, and checkout quick for delivery or pickup.',
			stats: ['Sushi, sashimi, rolls, drinks, and combo sets', 'Mobile-first ordering for delivery or pickup', 'Restaurant and menu schema ready for search'],
		},
		seo: {
	...
	zh: {
		...
		story: { title: '像高级寿司吧一样安静细致，也像成熟外送网站一样高效。', body: '从握寿司、刺身到招牌卷物和套餐，整体体验在保持日式质感的同时，让用户能快速看清商品、完成自定义并顺畅下单。', stats: ['寿司、刺身、卷物、饮品与套餐分类完整', '移动端优先，支持配送与自取下单', '已具备餐厅与菜单搜索结构化数据'] },
		seo: { faqTitle: '常见问题', faqs: [{ q: '寿司是现点现做吗？', a: '是的，菜单围绕现做握寿司、刺身、卷物和热食小点设计，让每一单都更接近新鲜现制的体验。' }, { q: '可以选择配送或自取吗？', a: '可以，结账流程同时支持配送与自取，价格和订单信息会在同一个流程里即时更新。' }] },
	},
	fr: {
		...
		story: { title: 'Pensé comme un comptoir de sushi raffiné, conçu pour commander vite sur mobile.', body: 'Nigiri, sashimi, rolls signature et menus combinés sont présentés avec une navigation claire, des détails produit lisibles et un checkout fluide pour la livraison ou le retrait.', stats: ['Sushi, sashimi, rolls, boissons et menus', 'Commande mobile-first avec livraison ou retrait', 'Données structurées prêtes pour restaurant et menu'] },
	...
	de: {
		...
		story: { title: 'Gestaltet wie ein ruhiger Sushi-Counter, aufgebaut für schnelles Bestellen auf jedem Bildschirm.', body: 'Von Nigiri und Sashimi bis zu Signature Rolls und Kombi-Menüs bleibt das Erlebnis hochwertig, klar strukturiert und schnell genug für Lieferung oder Abholung.', stats: ['Sushi, Sashimi, Rolls, Getränke und Kombis', 'Mobile-first Bestellfluss für Lieferung oder Abholung', 'Restaurant- und Menü-Schema für Suche vorbereitet'] },
		seo: { faqTitle: 'Häufige Fragen', faqs: [{ q: 'Wird das Sushi frisch auf Bestellung vorbereitet?', a: 'Ja. Das Menü ist auf frisch zubereitete Sushi, Sashimi, Rolls und warme Beilagen ausgelegt, damit jede Bestellung möglichst frisch wirkt.' }, { q: 'Können Kundinnen und Kunden Lieferung oder Abholung wählen?', a: 'Ja. Im Checkout lassen sich Lieferung und Abholung im selben Ablauf auswählen, inklusive sofort aktualisierter Bestelldetails.' }] },
	},
	es: {
		...
		story: { title: 'Diseñado como una barra de sushi refinada y pensado para pedir rápido en móvil.', body: 'Nigiri, sashimi, rolls de autor y combos se presentan con una navegación clara, fichas de producto útiles y un checkout fluido para entrega o recogida.', stats: ['Sushi, sashimi, rolls, bebidas y combos', 'Pedido mobile-first con entrega o recogida', 'Schema de restaurante y menú listo para buscadores'] },
	...
	pt: {
		...
		story: { title: 'Desenhado como um balcão de sushi refinado, feito para encomendar rápido em qualquer ecrã.', body: 'Nigiri, sashimi, rolls de assinatura e combos aparecem com navegação clara, detalhes úteis e um checkout fluido para entrega ou recolha.', stats: ['Sushi, sashimi, rolls, bebidas e combos', 'Encomenda mobile-first com entrega ou recolha', 'Schema de restaurante e menu pronto para pesquisa'] },
		seo: { faqTitle: 'Perguntas frequentes', faqs: [{ q: 'O sushi é preparado na hora?', a: 'Sim. O site foi pensado para sushi, sashimi, rolls e acompanhamentos preparados por encomenda, com foco numa perceção clara de frescura.' }, { q: 'É possível escolher entrega ou recolha?', a: 'Sim. O checkout permite alternar entre entrega e recolha no mesmo fluxo, com os detalhes do pedido atualizados de imediato.' }] },
	},
	it: {
		...
		story: { title: 'Progettato come un sushi bar raffinato, costruito per ordinare velocemente su ogni schermo.', body: 'Nigiri, sashimi, rolls signature e combo vengono presentati con navigazione chiara, dettagli prodotto leggibili e un checkout fluido per consegna o ritiro.', stats: ['Sushi, sashimi, rolls, bevande e combo', 'Ordine mobile-first con consegna o ritiro', 'Schema ristorante e menu pronto per la ricerca'] },
		seo: { faqTitle: 'Domande frequenti', faqs: [{ q: 'Il sushi viene preparato al momento?', a: 'Sì. L’esperienza è pensata per sushi, sashimi, rolls e contorni preparati su ordinazione, così ogni ordine comunica freschezza.' }, { q: 'Si può scegliere tra consegna e ritiro?', a: 'Sì. Il checkout gestisce consegna e ritiro nello stesso flusso e aggiorna subito i dettagli dell’ordine.' }] },
	},
};
