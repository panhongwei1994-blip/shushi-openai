...
export const translations: Record<Locale, Dictionary> = {
	en: {
		...
		story: {
			title: 'A calm sushi brand on the surface, a fast ordering flow underneath.',
			body: 'The menu moves from nigiri and sashimi to signature rolls and boxed sets with clear choices, restrained copy, and a checkout flow that stays quick on mobile.',
	...
	zh: {
		...
		story: { title: '表面是安静克制的寿司品牌，底层是顺手高效的下单流程。', body: '从握寿司、刺身到招牌卷物和套餐，页面用更清晰的商品信息、更克制的文案和更直接的操作路径，让手机点单也保持高级感。', stats: ['寿司、刺身、卷物、饮品与套餐分类完整', '移动端优先，支持配送与自取下单', '已具备餐厅与菜单搜索结构化数据'] },
	...
	fr: {
		...
		story: { title: 'Une marque de sushi calme en façade, un parcours de commande rapide en profondeur.', body: 'Du nigiri et sashimi aux rolls signature et box, l’expérience garde une présentation nette, un texte plus retenu et un checkout fluide pour mobile.', stats: ['Sushi, sashimi, rolls, boissons et menus', 'Commande mobile-first avec livraison ou retrait', 'Données structurées prêtes pour restaurant et menu'] },
	...
	de: {
		...
		story: { title: 'Nach außen ruhig und hochwertig, darunter ein schneller Bestellfluss für Sushi.', body: 'Von Nigiri und Sashimi bis zu Signature Rolls und Boxen bleibt die Seite klar, reduziert und schnell genug, damit Bestellungen auf dem Handy ohne Reibung funktionieren.', stats: ['Sushi, Sashimi, Rolls, Getränke und Kombis', 'Mobile-first Bestellfluss für Lieferung oder Abholung', 'Restaurant- und Menü-Schema für Suche vorbereitet'] },
	...
	es: {
		...
		story: { title: 'Una marca de sushi serena por fuera, un flujo de pedido rápido por dentro.', body: 'Desde nigiri y sashimi hasta rolls de autor y combos, la página mantiene una presentación limpia, texto más preciso y un checkout ágil para móvil.', stats: ['Sushi, sashimi, rolls, bebidas y combos', 'Pedido mobile-first con entrega o recogida', 'Schema de restaurante y menú listo para buscadores'] },
	...
	pt: {
		...
		story: { title: 'Uma marca de sushi calma na aparência, com um fluxo de encomenda rápido por baixo.', body: 'De nigiri e sashimi a rolls de assinatura e combos, a experiência mantém informação clara, texto mais contido e um checkout rápido em mobile.', stats: ['Sushi, sashimi, rolls, bebidas e combos', 'Encomenda mobile-first com entrega ou recolha', 'Schema de restaurante e menu pronto para pesquisa'] },
	...
	it: {
		...
		story: { title: 'Un brand sushi calmo in superficie, con un flusso d’ordine rapido sotto.', body: 'Da nigiri e sashimi a rolls signature e combo, la pagina resta pulita, più misurata nel testo e veloce nel checkout anche da mobile.', stats: ['Sushi, sashimi, rolls, bevande e combo', 'Ordine mobile-first con consegna o ritiro', 'Schema ristorante e menu pronto per la ricerca'] },
